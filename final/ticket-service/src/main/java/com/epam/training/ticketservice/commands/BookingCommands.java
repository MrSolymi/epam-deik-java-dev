...
public class BookingCommands {
    ...
    @ShellMethod(key = "book", value = "Book by <movie title> <room name> <starting date in YYYY-MM-DD hh:mm format> seat in \"<row>,<column>\" format, for book more seat separate the seats with space key")
